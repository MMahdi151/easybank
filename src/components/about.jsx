export default function About() {
  return (
    <section className="bg-grayblue-200 min-h-screen w-screen flex items-center place-content-center max-w-screen-2xl relative py-16 px-6 lg:p-0 text-center lg:text-left">
      <div className="flex flex-col gap-24 items-center max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-14">
          <div className="flex flex-col gap-6 lg:w-1/4 items-center lg:items-start">
            ...
            <h3 className="text-3xl mt-4">Online Banking</h3>
            <p>
          ...
          <div className="flex flex-col gap-6 lg:w-1/4 items-center lg:items-start">
            ...
            <h3 className="text-3xl mt-4">Simple Budgeting</h3>
            <p>
          ...
          <div className="flex flex-col gap-6 lg:w-1/4 items-center lg:items-start">
            ...
            <h3 className="text-3xl mt-4">Fast Onboarding</h3>
            <p>
          ...
          <div className="flex flex-col gap-6 lg:w-1/4 items-center lg:items-start">
            ...
            <h3 className="text-3xl mt-4">Open API</h3>
            <p>
